...
## وضعیت فعلی
- **مرحله ۱۵ از ۲۰ در حال اجراست: Auth + RLS + Security.**
- احراز هویت ایمیل/رمز عبور و مسیر حساب کاربری به MVP اضافه شده است.
- RLS روی جداول عمومی فعال/سخت‌گیرانه شده و دسترسی نوشتن بر اساس مالکیت محدود شده است.
- توابع امتیازدهی حساس از اجرای مستقیم `anon` و `authenticated` خارج شده‌اند.
